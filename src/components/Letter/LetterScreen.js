  ...
  return (
    <div className="letter-screen">
      <div className="letter-box">
        ...
        <p>Cảm ơn em đã yêu anh 1 năm 1 tháng 15 ngày... anh đã rất vui, vì được đồng hành cùng e, cùng nhau lắng nghe, thấu hiểu nhau. Thời gian được ở canh e tuy không nhiều nhưng anh đều rất vui, yêu xa nhiều thiệt thòi nhỉ... nhưng cũng là thử thách để a trân trọng tình cảm của chúng mình hơn </p>
